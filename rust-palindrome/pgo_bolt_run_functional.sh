...
# Combined PGO -> BOLT pipeline using cargo-pgo for functional versions
...
# --- Smallest Functional ---
pgo_one palprod-rust-functional-smallest palprod-rust-functional-smallest
bolt_one_with_pgo palprod-rust-functional-smallest palprod-rust-functional-smallest

# Clear PGO profiles to avoid cross-contamination
rm -rf target/pgo-profiles || true

# --- Largest Functional ---
pgo_one palprod-rust-functional-largest  palprod-rust-functional-largest
bolt_one_with_pgo palprod-rust-functional-largest  palprod-rust-functional-largest

echo "[DONE] Functional outputs in ../target-bin:"
echo " - palprod-rust-functional-smallest-pgo-instrumented"
echo " - palprod-rust-functional-smallest-bolt-optimized"
echo " - palprod-rust-functional-largest-pgo-instrumented"
echo " - palprod-rust-functional-largest-bolt-optimized"
