...
# --- Smallest ---
pgo_one palprod-rust-smallest palprod-rust-smallest
bolt_one_with_pgo palprod-rust-smallest palprod-rust-smallest

# Clear PGO profiles to avoid cross-contamination
rm -rf target/pgo-profiles || true

# --- Largest ---
pgo_one palprod-rust-largest  palprod-rust-largest
bolt_one_with_pgo palprod-rust-largest  palprod-rust-largest

echo "[DONE] Outputs in ../target-bin:"
echo " - palprod-rust-smallest-pgo-instrumented"
echo " - palprod-rust-smallest-bolt-optimized"
echo " - palprod-rust-largest-pgo-instrumented"
echo " - palprod-rust-largest-bolt-optimized"
