...
|------------------------------+--------+----------+-----------|
| Haskell                      | 2..999 | largest  | 1.5703 µs |
| Rust                         | 2..999 | largest  | 1.6506 µs |
| Rust Functional              | 2..999 | largest  | 1.7033 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.7248 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.7716 µs |
| Common Lisp                  | 2..999 | largest  | 2.1313 µs |
| Golang                       | 2..999 | largest  | 2.2154 µs |
...
| Haskell                      | 2..999 | smallest | 2.0275 µs |
| Rust Functional              | 2..999 | smallest | 2.1557 µs |
| Rust                         | 2..999 | smallest | 2.5117 µs |
| Common Lisp                  | 2..999 | smallest | 2.9560 µs |
| Golang                       | 2..999 | smallest | 3.0891 µs |
