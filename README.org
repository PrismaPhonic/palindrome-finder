...
| Rust Functional              | 2..999 | largest  | 1.7381 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.8917 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.9159 µs |
| Rust                         | 2..999 | largest  | 1.9657 µs |
| Golang                       | 2..999 | largest  | 2.2171 µs |
| Common Lisp                  | 2..999 | largest  | 2.2913 µs |
| Coalton                      | 2..999 | largest  | 2.5740 µs |
| Rust Functional (PGO + Bolt) | 2..999 | smallest | 1.9688 µs |
| Haskell                      | 2..999 | smallest | 2.0212 µs |
| Rust (PGO + Bolt)            | 2..999 | smallest | 2.2951 µs |
| Rust Functional              | 2..999 | smallest | 2.4766 µs |
| Rust                         | 2..999 | smallest | 2.7379 µs |
| Golang                       | 2..999 | smallest | 3.0846 µs |
| Common Lisp                  | 2..999 | smallest | 3.1917 µs |
| Coalton                      | 2..999 | smallest | 3.6518 µs |
|                              |        |          |           |
