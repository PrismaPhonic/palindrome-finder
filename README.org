...
|------------------------------+--------+---------+-----------|
| Rust                         | 2..999 | largest | 1.4033 µs |
| Rust Functional              | 2..999 | largest | 1.4891 µs |
| Haskell                      | 2..999 | largest | 1.4998 µs |
| Rust (PGO + Bolt)            | 2..999 | largest | 1.5073 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest | 1.5204 µs |
| Rust Simd                    | 2..999 | largest | 1.9310 µs |
| Rust Simd (PGO + Bolt)       | 2..999 | largest | 1.9585 µs |
| Golang (PGO)                 | 2..999 | largest | 2.1527 µs |
| Golang                       | 2..999 | largest | 2.1576 µs |
| Common Lisp                  | 2..999 | largest | 2.2169 µs |
| Coalton                      | 2..999 | largest | 2.5700 µs |
| Typescript (Bun)             | 2..999 | largest | 2.7205 µs |
| Typescript (Deno)            | 2..999 | largest | 3.0037 µs |
| Python (PyPy)                | 2..999 | largest | 4.9943 µs |
| Python (CPython)             | 2..999 | largest | 113.77 µs |

Latest average times per iteration for smallest

| Implementation               |  Range | Task     | Time      |
|------------------------------+--------+----------+-----------|
| Rust Functional              | 2..999 | smallest | 1.6370 µs |
| Rust Simd (PGO + Bolt)       | 2..999 | smallest | 1.6379 µs |
| Rust                         | 2..999 | smallest | 1.6713 µs |
| Rust (PGO + Bolt)            | 2..999 | smallest | 1.6890 µs |
| Rust Functional (PGO + Bolt) | 2..999 | smallest | 1.7008 µs |
| Rust Simd                    | 2..999 | smallest | 1.7228 µs |
| Haskell                      | 2..999 | smallest | 2.0225 µs |
| Golang (PGO)                 | 2..999 | smallest | 2.9359 µs |
| Common Lisp                  | 2..999 | smallest | 3.0984 µs |
| Golang                       | 2..999 | smallest | 3.1503 µs |
| Coalton                      | 2..999 | smallest | 3.6000 µs |
| Typescript (Bun)             | 2..999 | smallest | 4.0457 µs |
| Typescript (Deno)            | 2..999 | smallest | 4.6987 µs |
| Python (PyPy)                | 2..999 | smallest | 10.044 µs |
| Python (CPython)             | 2..999 | smallest | 228.37 µs |
