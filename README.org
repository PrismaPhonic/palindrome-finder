...
|------------------------------+--------+----------+-----------|
| Rust Functional              | 2..999 | largest  | 1.7296 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.7381 µs |
| Haskell                      | 2..999 | largest  | 1.8788 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.9668 µs |
| Rust                         | 2..999 | largest  | 1.9746 µs |
| Common Lisp                  | 2..999 | largest  | 2.2805 µs |
| Golang                       | 2..999 | largest  | 2.4787 µs |
| Coalton                      | 2..999 | largest  | 2.5278 µs |
| Rust Functional (PGO + Bolt) | 2..999 | smallest | 2.0081 µs |
| Rust Functional              | 2..999 | smallest | 2.2334 µs |
| Rust (PGO + Bolt)            | 2..999 | smallest | 2.3492 µs |
| Haskell                      | 2..999 | smallest | 2.4570 µs |
| Rust                         | 2..999 | smallest | 2.6980 µs |
| Common Lisp                  | 2..999 | smallest | 3.3533 µs |
| Golang                       | 2..999 | smallest | 3.6945 µs |
| Coalton                      | 2..999 | smallest | 3.7540 µs |
|                              |        |          |           |
