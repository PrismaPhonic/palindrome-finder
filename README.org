...
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.8918 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.9160 µs |
| Rust                         | 2..999 | largest  | 1.9580 µs |
| Common Lisp                  | 2..999 | largest  | 2.1313 µs |
| Golang                       | 2..999 | largest  | 2.2061 µs |
...
| Rust (PGO + Bolt)            | 2..999 | smallest | 2.2947 µs |
| Rust                         | 2..999 | smallest | 2.7408 µs |
| Golang                       | 2..999 | smallest | 3.0774 µs |
| Common Lisp                  | 2..999 | smallest | 3.1992 µs |
| Golang (PGO)                 | 2..999 | smallest | 3.2679 µs |
| Coalton                      | 2..999 | smallest | 3.5321 µs |
|                              |        |          |           |
