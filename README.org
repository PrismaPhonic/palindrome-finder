...
|------------------------------+--------+----------+-----------|
| Haskell                      | 2..999 | largest  | 1.5631 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.7248 µs |
| Rust Functional              | 2..999 | largest  | 1.7595 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.7716 µs |
| Rust                         | 2..999 | largest  | 1.7848 µs |
| Rust Simd (PGO + Bolt)       | 2..999 | largest  | 1.8377 µs |
| Rust Simd                    | 2..999 | largest  | 1.9227 µs |
| Common Lisp                  | 2..999 | largest  | 2.1859 µs |
| Golang                       | 2..999 | largest  | 2.1985 µs |
| Golang (PGO)                 | 2..999 | largest  | 2.2430 µs |
| Coalton                      | 2..999 | largest  | 2.6163 µs |
| Rust Simd (PGO + Bolt)       | 2..999 | smallest | 1.7229 µs |
| Rust Simd                    | 2..999 | smallest | 1.8348 µs |
| Rust Functional (PGO + Bolt) | 2..999 | smallest | 1.9471 µs |
| Rust (PGO + Bolt)            | 2..999 | smallest | 1.9569 µs |
| Haskell                      | 2..999 | smallest | 2.0281 µs |
| Rust Functional              | 2..999 | smallest | 2.2424 µs |
| Rust                         | 2..999 | smallest | 2.4151 µs |
| Common Lisp                  | 2..999 | smallest | 3.0536 µs |
| Golang                       | 2..999 | smallest | 3.0982 µs |
| Golang (PGO)                 | 2..999 | smallest | 3.2679 µs |
| Coalton                      | 2..999 | smallest | 3.6459 µs |
|                              |        |          |           |
