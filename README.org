...
|----------------+----------+----------+-----------|
| fast (Lisp)    | 100..999 | largest  | 7.7364 µs |
| fast (Lisp)    | 910..999 | smallest | 2.3080 µs |
| comm (Lisp)    | 100..999 | largest  | 6.9058 ms |
| comm (Lisp)    | 910..999 | smallest | 2.2301 ms |
| Rust           | 100..999 | largest  | 10.403 µs |
| Rust           | 910..999 | smallest | 2.3443 µs |
