...
|------------------------------+--------+----------+-----------|
| Haskell                      | 2..999 | largest  | 1.5626 µs |
| Rust Functional (PGO + Bolt) | 2..999 | largest  | 1.9017 µs |
| Rust Functional              | 2..999 | largest  | 1.7593 µs |
| Rust (PGO + Bolt)            | 2..999 | largest  | 1.8111 µs |
| Rust                         | 2..999 | largest  | 1.6691 µs |
| Rust Simd (PGO + Bolt)       | 2..999 | largest  | 1.9786 µs |
| Rust Simd                    | 2..999 | largest  | 1.9457 µs |
| Common Lisp                  | 2..999 | largest  | 2.2020 µs |
...
| Implementation               |  Range | Task     | Time      |
|------------------------------+--------+----------+-----------|
| Rust Simd (PGO + Bolt)       | 2..999 | smallest | 1.6564 µs |
| Rust Simd                    | 2..999 | smallest | 1.7416 µs |
| Rust Functional (PGO + Bolt) | 2..999 | smallest | 2.0335 µs |
| Rust (PGO + Bolt)            | 2..999 | smallest | 1.9594 µs |
| Haskell                      | 2..999 | smallest | 2.0280 µs |
| Rust Functional              | 2..999 | smallest | 2.2158 µs |
| Rust                         | 2..999 | smallest | 2.3732 µs |
| Common Lisp                  | 2..999 | smallest | 3.0628 µs |
